...
L922F:  call    L93D8
        ...
        call    0xB3AF
        ld      (L98FB),de
        ld      (L9254+1),de    ; reference not aligned to instruction
        call    0xB3DB
        call    0xB3AF
        ld      a,(hl)
        cp      0x2C            ; ','
        ...
        ; Referenced from 9249
L9250:  ld      a,0x02

        ; Referenced from 924E
L9252:  push    hl
        ex      de,hl

        ; Referenced from 923C
L9254:  ld      de,0x0000
        sbc     hl,de
        ld      (L98FD),hl
        ld      (L98F8+1),a     ; reference not aligned to instruction
...
L92BC:  call    L93D8
        ...
        ; Referenced from 92E3
L92D9:  ld      a,(hl)
        cp      c
        jr      nz,L92DF
        ld      (hl),0xFF

        ; Referenced from 92DB
L92DF:  inc     hl
        dec     de
        ld      a,d
        or      e
...
L9779:  adc     a,e
        ...
        ld      b,b
        rlca
        djnz    L9795+2         ; reference not aligned to instruction
        ld      a,b
        ld      (hl),b
        or      b
